...
- Offline cache (Opus): [`../superpowers/specs/2026-09-11-ytcli-offline-cache-design.md`](../superpowers/specs/2026-09-11-ytcli-offline-cache-design.md)
...
| [0007](0007-roadmap-cli-luego-tui.md) | Roadmap | CLI → cola → pulido → Spotify → playlists → offline → TUI |
...
| [0012](0012-offline-cache-opus.md) | Offline | Opus 160 cache + prefer file |
